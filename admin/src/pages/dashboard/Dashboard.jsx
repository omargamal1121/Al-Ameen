...
const Dashboard = ({ token }) => {
  ...
  const normalizeStatus = (s) => {
    ...
    return match || str || t('pendingPayment')
  }
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-gray-50/50">
                      ...
                      <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-gray-400 text-right">{t('status')}</th>
                    </tr>
                  </thead>
